"""Rich rendering helpers for Gemini token usage statistics."""
...
def render_daily_usage_statistics(report: DailyUsageStatistics, console: Console) -> None:
    """Render daily and overall usage statistics tables."""
...
def _print_usage_table(
    ...
    for key, stats in data:
        total_stats += stats
        total_tokens = stats.input_tokens + stats.output_tokens + stats.thoughts_tokens
